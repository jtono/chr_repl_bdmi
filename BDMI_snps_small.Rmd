...
```{r, echo=FALSE}
plot(FW$f1altf~FW$pos, col="blue", type="l")
lines(FW$f2altf~FW$pos, col="black")
```
...
FW_cutcut4 <- trimsnps_w(FW_cutcut3, FW_cutcut4, 10765,100)
```
find 0.001 edge
```{r}
sumlo <- loess(FWcut4$f2altf+FWcut4$f1altf-0.5~FWcut4$pos, span=0.2)
length(sumlo$fitted)
```
...
plot(FWcut4$f1altf~FWcut4$pos, col="blue", type="l")
lines(FWcut4$f2altf~FWcut4$pos, col="black")
lines(FWcut4$f2altf+FWcut4$f1altf-0.5~FWcut4$pos, col="pink")
lines(sumlo$fitted~FWcut4$pos, col="red")
abline(v=c(sumlo$x[which(sumlo$fitted<=0.3695023)]), lty=2)
```
...
```{r, echo=FALSE}
lo1 <- loess(FW_cutcut4$altf1~FW_cutcut4$pos, span=0.2)
lo2 <- loess(FW_cutcut4$altf2~FW_cutcut4$pos, span=0.2)
plot(FW_cutcut4$altf1~FW_cutcut4$pos, type="l", ylim = c(0,1.2), xlim=c(58476,289967),col="black", ylab="freq par (mapped to cer)", xlab="position along chromosome")
lines(lo1$fitted~FW_cutcut4$pos, col='purple', lwd=2)
lines(FW_cutcut4$altf2~FW_cutcut4$pos, col="black")
lines(lo2$fitted~FW_cutcut4$pos, col='purple', lwd=2)
fitsW <- (lo1$fitted+lo2$fitted)
lines((fitsW-0.5)~FW_cutcut4$pos, col="red")
abline(h=0.5, col="black", lty=2)
